      ...
      <div className="border-t border-white/10 p-4 space-y-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-sm text-white"
          />

          <button
            onClick={() => sendMessage(input)}
            className="px-5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white"
          >
            Enviar
          </button>
        </div>
