    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Amount Input */}
          <div>
            <label className="block text-xs font-medium text-white/50 mb-2">Valor do aporte *</label>
            <input
              type="text"
              inputMode="numeric"
          ...
          {/* Note */}
          <div>
            <label className="block text-xs font-medium text-white/50 mb-2">Observação (opcional)</label>
            <input
              type="text"
              value={note}
          ...
          <div className="flex gap-3">
            ...
            <motion.button
              ...
              style={{
                ...
                boxShadow: parsedAmount > 0 ? "0 6px 24px rgba(168,85,247,0.35)" : "none",
