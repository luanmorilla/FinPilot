    ...
    <>
      ...
      >
        <motion.div
          ...
          exit={{ y: 60, opacity: 0 }}
          transition={{ type: "spring", damping: 28, stiffness: 300 }}
          className="w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl flex flex-col mb-5 sm:mb-0"
          style={{
            background: "#13131a",
            border: "1px solid rgba(255,255,255,0.1)",
            ...
            // mb-5 dá um respiro entre o card e a nav, em vez de ficar colado.
            height: "min(calc(100% - 20px), 720px)",
          }}
        >
          {/* Header fixo */}
          <div
